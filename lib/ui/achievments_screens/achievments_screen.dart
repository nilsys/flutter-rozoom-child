                                  ...
                                  children: [
                                    Stack(
                                      children: [
                                       ...
                                       ( achiev.achievWithCat(index)[i].imageUrl == 'assets/images/achievements/2.png') || ( achiev.achievWithCat(index)[i].imageUrl == 'assets/images/achievements/3.png')  ?
                                       Positioned.fill(
                                          bottom:defaultSize*2,
                                          right: defaultSize*2,
                                          child: Align(
                                        ...
                                        ) : ( achiev.achievWithCat(index)[i].imageUrl == 'assets/images/achievements/4.png') ?
                                         Positioned.fill(
                                          left: defaultSize * 6,
                                          top: defaultSize * 5.5,
                                          child: Align(
                                         ...
                                         ( achiev.achievWithCat(index)[i].imageUrl == 'assets/images/achievements/5.png') || ( achiev.achievWithCat(index)[i].imageUrl == 'assets/images/achievements/6.png')  ?
                                        Positioned.fill(
                                          right: defaultSize * 2,
                                          top: defaultSize,
                                          child: Align(
                                         ...
                                         ( achiev.achievWithCat(index)[i].imageUrl == 'assets/images/achievements/7.png') ?
                                        Positioned.fill(
                                    ...
                                    Container(
                                      ...
                                      child: 
                                      (achiev.achievWithCat(index)[i].status == 'rewarded') ?
                                      RaisedButton(
                                          elevation: 0,
                                          onPressed: () {},
                                          color: Colors.white,
                                          ...
                                          (achiev.achievWithCat(index)[i].status == 'received') ?
                                          achiev.isLoadingWidget ? myLoaderWidget() :
                                       RaisedButton(
                                          elevation: 0,
                                          onPressed: () async {
                                            await _getReward(context, achiev.achievWithCat(index)[i].id);
                                            MyDialogs().showOkDialog(context, achiev.dialogMessage);            
                                          },
                                          color: Colors.white,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Center(child: Text('Отримати'),),
                                          ),) :  
                                        RaisedButton(
                                          elevation: 0,
                                          onPressed: () {
                                          ...
                                          child: Padding(
                                            ...
                                            child: Center(child: Text('Недоступно'),),
                                          ),
                                        ),
                                  ),
                                  ],
